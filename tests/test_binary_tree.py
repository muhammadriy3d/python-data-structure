...
class TestBinaryroot(unittest.TestCase):
    ...
    def test_insert_duplicate(self):
        ...
        self.assertEqual(self.root.tree.right.data, 10)
        self.assertIsNone(self.root.tree.left)
    ...
    def test_dfs_full_tree(self):
        ...
        self.root.insert(5)
        self.root.insert(15)
        self.assertEqual(self.root.dfs(self.root.tree), [10, 5, 15])
    ...
    def test_dfs_pre_order(self):
        ...
        self.assertEqual(self.root.dfs_recursion(self.root.tree)[1][0], 5)
        self.assertEqual(self.root.dfs_recursion(self.root.tree)[2][0], 15)
